    ...
    <div class="row justify-content-center mf">
      <div class="col-lg-6 shadow-lg rounded-3 right-side">
        <form @submit.prevent="ChangeData()">
          <p class="bg-info text-primary title-form px-3 py-2 rounded-top">Update Barang</p>
          <div class="row pf">
            <div class="col-3">
              <label for="NamaBarang" class="form-label">Nama Barang</label>
            </div>
            <div class="col-8">
              <input v-model="namaBarang" type="text" class="form-control" id="NamaBarang" name="namaBarang" placeholder="Enter Nama Barang" autofocus />
            </div>
          </div>
          <div class="row pf">
            <div class="col-3">
            ...
            <div class="col-8">
              <input v-model="harga" type="text" class="form-control" id="hargaBarang" name="harga" placeholder="Enter Harga Barang" autofocus />
            </div>
          </div>
          <div class="row pf">
            <div class="col-3">
            ...
            <div class="col-8">
              <input v-model="stok" type="text" class="form-control" id="StokBarang" name="stok" placeholder="Enter Stok Barang" autofocus />
            </div>
          </div>
          <div class="row pf">
            <div class="col-3">
...
export default {
  ...
  methods: {
    async getUpdateBarang() {
      ...
      (this.namaBarang = data.data.namaBarang), (this.harga = data.data.harga), (this.stok = data.data.stok), (this.supplier = data.data.supplier);
